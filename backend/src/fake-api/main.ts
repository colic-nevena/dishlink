...
// IMPORTANT: OVO JE queries and commands layer, pozivace ih controller
...
//  ------------------------------------------------------------------
//[PUT] /api/cookbook/:cookbookId => command!!!
...
async function addRecipeToCookbook(request: AddRecipeRequest) {
